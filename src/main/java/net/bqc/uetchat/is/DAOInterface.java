...
public interface DAOInterface {
	...
	public static final String ADD_CHAT =
			"INSERT INTO `chat_sessions` (lhs_fb_id, rhs_fb_id) VALUES (?, ?)";
	public static final String REMOVE_CHAT_BY_USER_ID =
			"DELETE FROM `chat_sessions` WHERE lhs_fb_id = ? OR rhs_fb_id = ?";
	...
	public static final String GET_PARTNER_IN_CHAT =
			"SELECT rhs_fb_id FROM `chat_sessions` WHERE lhs_fb_id = ?";
	...
	public static final String FIND_CHAT_BY_USER_ID =
			"SELECT lhs_fb_id FROM `chat_sessions` WHERE `lhs_fb_id` = ? OR `rhs_fb_id` = ?";
